...
**Версия:** 3.6 (native Swift)
**Платформа:** macOS 14+ (Sonoma), Apple Silicon (M1/M2/M3/M4)
**Стек:** Swift 6 + SwiftUI + whisper.cpp (static linking) + Metal + FluidAudio (Parakeet Core ML / ANE) + WhisperKit (Argmax, whisper-large-v3 на ANE)
